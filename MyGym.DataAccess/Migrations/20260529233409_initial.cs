        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("User_Phone_CK", "LEN([Phone]) = 11 AND [Phone] LIKE '01[0125]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HireDate = table.Column<DateTime>(type: "date", nullable: false, defaultValueSql: "CAST(GETDATE() AS DATE)"),
                    Address_City = table.Column<string>(type: "varchar(30)", nullable: false),
                    Address_Street = table.Column<string>(type: "varchar(30)", nullable: false),
                    Address_BuildingNumber = table.Column<int>(type: "int", nullable: false),
                    JoinDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("User_Phone_CK1", "LEN([Phone]) = 11 AND [Phone] LIKE '01[0125]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BloodType = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StartDate = table.Column<DateTime>(type: "date", nullable: false, defaultValueSql: "CAST(GETDATE() AS DATE)"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Session_Date", "[StartDate] < [EndDate]");
                    table.ForeignKey(
